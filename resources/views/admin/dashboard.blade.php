...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>1st September 2017</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      <!-- Info boxes -->
      <div class="row">
        <div class="rythm rythm-high col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
        ...
        <!-- /.col -->
        <div class="rythm twist3 col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
        ...
        <div class="rythm twist1 col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
              ...
              <div class="row">
                <div class="col-md-10 col-sm-9">
                  <div class="pad">
                    ...
                    <div id="world-map-markers" style="height: 210px;"></div>
                  </div>
                </div>
                <!-- /.col -->
                <div class="col-md-2 col-sm-3">
                  <div class="pad box-pane-right" style="min-height: 250px">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-md-8">
                  <p class="text-center">
                    <strong>Returns: 1 Jan, 2014 - 30 Jul, 2014</strong>
                  </p>
                ...
                <div class="col-md-4">
                  ...
                  <div class="progress-group">
                    <span class="progress-text">Android App Advertisement</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Vendors Registration</span>
