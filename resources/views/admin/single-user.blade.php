          ...
          <div class="col-md-3">
            ...
            <div class="box box-primary">
              <div class="box-body box-profile">
                ...
                <h3 class="profile-username text-center">Victoria Ndunge</h3>

                <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                        <b>Joined On</b> <a class="pull-right">11-5-2017</a>
                    </li>
                    <li class="list-group-item">
                        <b>Gender</b> <a class="pull-right">Female</a>
                    </li>
                  <li class="list-group-item">
                    <b>Status</b> <span class="label label-success pull-right">Approved</span>
                  </li>
                  <li class="list-group-item">
                    <b>Marital Status</b> <a class="pull-right">None</a>
                  </li>
                  <li class="list-group-item">
                    <b>Email</b> <a class="pull-right">findingedward@gmail.com</a>
                  </li>
                </ul>
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Marital Status Info</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
